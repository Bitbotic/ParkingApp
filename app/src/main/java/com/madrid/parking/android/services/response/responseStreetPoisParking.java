...
import com.madrid.parking.android.model.VectorPoisParking;
...
public class responseStreetPoisParking implements KvmSerializable {

    public VectorPoisParking data;
    public int code;
    public boolean codeSpecified;
    public String message;

    public responseStreetPoisParking() {
    }

    public responseStreetPoisParking(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("Data")) {
            SoapObject j = (SoapObject) soapObject.getProperty("Data");
            data = new VectorPoisParking(j);
        }
