...
import com.madrid.parking.android.model.VectorpoiDetail;
...
public class responsePoiDetail implements KvmSerializable {

    public VectorpoiDetail data;
    public int code;
    public boolean codeSpecified;
    public String message;

    public responsePoiDetail() {
    }

    public responsePoiDetail(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("Data")) {
            SoapObject j = (SoapObject) soapObject.getProperty("Data");
            data = new VectorpoiDetail(j);
        }
