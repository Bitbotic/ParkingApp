...
public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.CustomViewHolder> implements SimpleItemTouchHelperCallback.ItemTouchHelperAdapter {
    private List<lstParking> feedItemList;
    private Context mContext;
    private int lastPosition = -1;

    private ItemTouchHelper mIth;

    public MyRecyclerAdapter(Context context, List<lstParking> feedItemList) {
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, int i) {
        lstParking feedItem = feedItemList.get(i);
