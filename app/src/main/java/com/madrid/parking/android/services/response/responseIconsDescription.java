...
import com.madrid.parking.android.model.VectoriconsDescription;
...
public class responseIconsDescription implements KvmSerializable {

    public VectoriconsDescription data;
    public int code;
    public boolean codeSpecified;
    public String message;

    public responseIconsDescription() {
    }

    public responseIconsDescription(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("Data")) {
            SoapObject j = (SoapObject) soapObject.getProperty("Data");
            data = new VectoriconsDescription(j);
        }
