...
public class Vectorfeature extends Vector<feature> implements KvmSerializable {


    public Vectorfeature() {
    }

    public Vectorfeature(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject != null) {
