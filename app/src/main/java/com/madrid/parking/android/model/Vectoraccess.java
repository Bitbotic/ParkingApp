...
public class Vectoraccess extends Vector<access> implements KvmSerializable {


    public Vectoraccess() {
    }

    public Vectoraccess(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject != null) {
