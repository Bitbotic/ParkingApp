...
public class Vectorrates extends Vector<rates> implements KvmSerializable {


    public Vectorrates() {
    }

    public Vectorrates(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject != null) {
