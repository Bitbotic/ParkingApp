...
import com.madrid.parking.android.model.VectorlstParking;
...
public class responseListParking implements KvmSerializable {

    public VectorlstParking data;
    public int code;
    public boolean codeSpecified;
    public String message;

    public responseListParking() {
    }

    public responseListParking(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("Data")) {
            SoapObject j = (SoapObject) soapObject.getProperty("Data");
            data = new VectorlstParking(j);
        }
