...
import com.madrid.parking.android.model.VectorparkingDetails;
...
public class responseParkingDetail implements KvmSerializable {

    public VectorparkingDetails data;
    public int code;
    public boolean codeSpecified;
    public String message;

    public responseParkingDetail() {
    }

    public responseParkingDetail(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("Data")) {
            SoapObject j = (SoapObject) soapObject.getProperty("Data");
            data = new VectorparkingDetails(j);
        }
