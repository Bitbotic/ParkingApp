...
import com.madrid.parking.android.model.VectorfeatureType;
...
public class responseListFeatures implements KvmSerializable {

    public VectorfeatureType data;
    public int code;
    public boolean codeSpecified;
    public String message;

    public responseListFeatures() {
    }

    public responseListFeatures(SoapObject soapObject) {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("Data")) {
            SoapObject j = (SoapObject) soapObject.getProperty("Data");
            data = new VectorfeatureType(j);
        }
